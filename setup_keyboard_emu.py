...
# Bluetooth HID Keyboard Emulator.
#
# It performs the following actions:
# 1. Installs necessary dependencies.
# 2. Configures the BlueZ service to allow HID emulation.
# 3. Creates the Python emulator script in the user's home directory.
#

# --- Script Configuration ---
PYTHON_SCRIPT_NAME="bt_keyboard_emu.py"
...
echo "--- Starting Raspberry Pi 5 Bluetooth Keyboard Setup ---"

# --- Step 1: Update System and Install Dependencies ---
echo "[1/5] Updating system and installing dependencies..."
apt-get update > /dev/null
apt-get install -y python3-dbus python3-gi libbluetooth-dev

echo "Dependencies installed successfully."

# --- Step 2: Configure the Bluetooth Service ---
echo "[2/5] Configuring Bluetooth service..."
...
echo "[3/5] Reloading systemd and restarting Bluetooth service..."
systemctl daemon-reload
systemctl restart bluetooth.service
echo "Bluetooth service restarted."

# --- Step 4: Create the Python Emulator Script ---
echo "[4/5] Creating Python emulator script at ${PYTHON_SCRIPT_PATH}..."

# Use a HEREDOC to write the Python script content
# This is a robust way to embed one script within another.
...
echo "[5/5] Setting ownership and permissions for the Python script..."
...
echo ""
echo "To start the keyboard emulator, run the following command:"
echo "  sudo ${PYTHON_SCRIPT_PATH}"
echo ""
